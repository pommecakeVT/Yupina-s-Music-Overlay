...
if __name__ == '__main__':
    ...
    menu_options = (
        ("Ouvrir le lien dans le navigateur", resource_path(os.path.join("data", "browser.ico")), open_browser),
    )
    systray = SysTrayIcon(resource_path(os.path.join("data", "music.ico")), "Yupina's Music Overlay", menu_options, on_quit=lambda _: os._exit(0))
    systray.start()
